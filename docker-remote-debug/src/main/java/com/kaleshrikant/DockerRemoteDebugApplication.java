...
public class DockerRemoteDebugApplication {
	private EmployeeRepository employeeRepository;

	public DockerRemoteDebugApplication(EmployeeRepository employeeRepository) {
	...
	public static void main(String[] args) {
		SpringApplication.run(DockerRemoteDebugApplication.class, args);
	}
}
